...
```javascript
const mdLinks = require('alicruz-md-links');
...
```
## Contributing
Pull requests are welcome. For major changes, please open an [issue]("https://github.com/AlissonCH/alicruz-md-links/issues") first to discuss what you would like to change.
